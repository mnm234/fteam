...
class HomeRecyclerAdapter(val context: Context?, objects: MutableList<HomeRecyclerItem>, val parent: MainActivity) : RecyclerView.Adapter<HomeRecyclerViewHolder>(), View.OnClickListener {
    ...
    var listItems: MutableList<HomeRecyclerItem> = objects
