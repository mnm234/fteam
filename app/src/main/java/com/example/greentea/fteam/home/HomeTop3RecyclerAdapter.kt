...
class HomeTop3RecyclerAdapter(val context: Context?, objects: MutableList<HomeTop3RecyclerItem>, val parent: MainActivity) : RecyclerView.Adapter<HomeTop3RecyclerViewHolder>(), View.OnClickListener {
    ...
    override fun onBindViewHolder(holder: HomeTop3RecyclerViewHolder, position: Int) {
        holder?.let {
...
//        return listItems.size
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeTop3RecyclerViewHolder {
        ...
        return HomeTop3RecyclerViewHolder(mView, this)
    }

}

class HomeTop3RecyclerViewHolder(view: View, HomeTop3RecyclerAdapter: HomeTop3RecyclerAdapter) : RecyclerView.ViewHolder(view), View.OnClickListener {
    override fun onClick(v: View?) {
...
//        }
//    }
    val adapter = HomeTop3RecyclerAdapter
